                ...
                <div class="card card-widget widget-user">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-4 border-right">
                                <div class="description-block">
                                    <h5 class="description-header">11,000</h5>
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="file" @change="updateProfile" class="form-input"  id="photo" ></input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" v-model="form.type" class="form-control" id="inputSkills" placeholder="Skills">
                                            </div>
                                        </div>
                                        <div class="form-group">
